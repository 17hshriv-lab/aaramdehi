        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className={`${
                ...
                <div className="p-6 border-b border-gray-700">
                    <h1 className="text-2xl font-black">Aaramdehi</h1>
                    <p className="text-xs text-gray-400">Admin Panel</p>
                </div>

                {/* Menu */}
                <nav className="flex-1 p-4 space-y-2">
                    <button onClick={() => navigate('/admin')} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-red-500 text-white hover:bg-red-600">
                        <IoHome size={20} />
                        <span>Dashboard</span>
                    </button>
                ...
                <div className="p-4 border-t border-gray-700">
                    <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-300 hover:bg-red-500">
                        <IoLogOut size={20} />
                        <span>Logout</span>
                    </button>
                </div>
