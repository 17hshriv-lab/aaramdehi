...
import { HelmetProvider } from 'react-helmet-async'; // Required for SEO Component
...
function AppContent() {
  ...
  const hideHeaderRoutes = ['/checkout', '/payment', '/order-success', '/login', '/signup'];
...
function App() {
  return (
    <HelmetProvider> {/* Wrapped in HelmetProvider for SEO */}
      <Router> 
        <AppContent />
      </Router>
    </HelmetProvider>
